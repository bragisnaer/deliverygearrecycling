...
- [x] Prison intake and counting: expected and unexpected deliveries, per-pickup forms, discrepancy tracking — Validated in Phase 5: Prison Intake and Counting
- [x] Batch/lot tracking with defective batch flags and quarantine alerts — Validated in Phase 5: Prison Intake and Counting
- [x] reco dashboard: aggregated cross-client view with client context switching — Validated in Phase 8: Dashboards and ESG Metrics
- [x] Client dashboard: per-location view (client role) and cross-market aggregated view (client-global role) — Validated in Phase 8: Dashboards and ESG Metrics
- [x] Transport dashboard for transport providers — Validated in Phase 8: Dashboards and ESG Metrics
- [x] ESG metrics: material recycling totals (grams × items), reuse rate, CO2 avoided stub, exportable PDF/CSV reports — Validated in Phase 8: Dashboards and ESG Metrics
